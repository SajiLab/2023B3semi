...
1.のとき、注目画素は新しくラベリングが必要な領域であるため、新しいラベルを付与します。

2.のとき、注目画素は左側の画素の連結成分であるため、左のラベルを注目画素に付与します。

3.のとき、注目画素は下側の画素の連結成分であるため、下のラベルを注目画素に付与します。

4.のとき、左のラベルと下のラベルを比べると下のほうが古いラベルであるため、下のラベルで注目画素を更新します。
...
注目画素値の決定がされ、アルゴリズムどおり注目画素にはラベル1が付与されます。そして、不要になった左ラベルも舌ラベルの数値である1に更新されます。
